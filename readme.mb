...
The why?
 ...
 1.  For each year and month , print the count of movies having rating greater than equal to 4

 2.  For each year and month , print the count of movies based on Genre having rating greater than equal to 4 Query 3. Print top-5 movies based on the rating by Students ( in occupation )

 3 . for each month, genre - create a new column that has comma separated list of movie
...
1. Write a spark application to read the Kafka topics(movie lens dataset) and print them in Console
5. Read the movie lens dataset in spark, write a spark application to get the Maximum Rating of each genre and find which genre is most rated by the users?
